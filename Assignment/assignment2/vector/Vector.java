...
public class Vector {
	...
	public static Vector random(int length, int seed) {
		...
		for (int i = 0; i < length; i++) {
			vector.elements[i] = random.nextInt(101);
		}
	 ...
	 */
	public static Vector uniform(int length, int value) {
	 ...
	 */
	public static boolean isPQ(int number) {
	 ...
	 */
	public static Vector pq(int length, int start) {
	 ...
	 */
	public static Vector prime(int length, int start) {
	 ...
	 */
	public static Vector abundant(int length, int start) {
	 ...
	 */
	public static Vector composite(int length, int start) {
